                ...
                {pesananForm.data.sheets_config.map((sheet, index) => (
                    <div key={index} className="p-5 bg-gray-50 rounded-2xl border border-gray-200 relative group">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <div className="flex flex-col justify-end"><InputLabel value="Kol. Outlet *" className="text-xs" /><TextInput className="mt-1 block w-full" value={sheet.col_nama_outlet} onChange={(e) => handleSheetChange(pesananForm, index, 'col_nama_outlet', e.target.value)} /></div>
