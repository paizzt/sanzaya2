<?php
$controllers = [
    'PurchaseOrderController' => ['PurchaseOrder', 'Surat Pesanan'],
    'ReceivableController' => ['Receivable', 'Data Piutang'],
    'PayableController' => ['Payable', 'Data Hutang'],
    'CompanyController' => ['Company', 'Data Perusahaan'],
    'OutletController' => ['Outlet', 'Data Outlet'],
    'VehicleController' => ['Vehicle', 'Data Armada'],
    'ProviderController' => ['Provider', 'Data Penyedia'],
    'ProductController' => ['Product', 'Data Produk'],
    'UserController' => ['User', 'Pengguna'],
];
