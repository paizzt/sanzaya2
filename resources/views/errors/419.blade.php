    ...
    <div class="max-w-lg w-full px-6">
        <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-10 text-center border border-gray-100">
            <div class="w-24 h-24 bg-rose-50 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg class="w-12 h-12 text-rose-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            </div>
            
            <h1 class="text-3xl font-bold text-gray-900 mb-2">419 - Sesi Berakhir</h1>
            <p class="text-gray-500 mb-8 leading-relaxed">
                Maaf, sesi Anda telah berakhir karena terlalu lama tidak ada aktivitas atau aplikasi baru saja diperbarui. Silakan muat ulang halaman ini untuk melanjutkan.
            </p>
